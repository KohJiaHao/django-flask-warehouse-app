...
SECRET_KEY = 'django-insecure-ia_yp#8kfzl*&59bd%aepedp0031trg+7cpw=x=)!17i4k!!6n'
...
DATABASES = {
    ...
    'default': {
        'ENGINE': 'django.db.backends.postgresql_psycopg2',
        'NAME': 'artiselite_warehouse_app',
        'USER': 'artiselite_programmer',
        'PASSWORD': os.getenv('DB_PASSWORD'),
        'HOST': 'hangman.postgres.database.azure.com',
        'PORT': '5432',
